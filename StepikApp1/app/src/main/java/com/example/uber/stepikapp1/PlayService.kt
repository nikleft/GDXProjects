...
class PlayService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        player?.setOnPreparedListener { p ->
            ...
            timer.schedule(object : TimerTask() {
                override fun run() {
                    ...
                    notification?.setContentText("${p.currentPosition / 1000} sec / ${p.duration / 1000}")
        ...
        val piStop = PendingIntent
                .getService(this, 0, iStop, PendingIntent.FLAG_CANCEL_CURRENT)
